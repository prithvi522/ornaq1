...
import { categoryOptions, isJewelleryCategory, mergeCategories, STANDARD_SIZES } from "../utils/catalog";
            ...
            <section className="space-y-8 rounded-[3rem] border border-stone-50 bg-white p-8 shadow-2xl shadow-stone-100 sm:p-10">
              <div>
                ...
                <div className="space-y-6">
                  ...
                  {/* Size Applicable & Available Sizes */}
                  <div className="space-y-4 rounded-2xl border border-stone-100 bg-stone-50/50 p-5">
                    <div className="flex items-center justify-between">
                      <div>
                        <label className="text-[10px] font-black uppercase tracking-widest text-stone-700">Size Applicable</label>
                          ...
                          {STANDARD_SIZES.map((size) => {
                            ...
                            return (
                              <button
                                ...
                                className={`flex h-12 min-w-[3.25rem] px-3 items-center justify-center rounded-xl border text-sm font-bold transition-all active:scale-95 ${
                                  isSelected
