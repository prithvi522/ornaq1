      ...
      return [
        {
          ...
          selectedColor:
            ...
            "",
          selectedSize: directCheckoutItem.selectedSize || directCheckoutItem.size || ""
        }
      ];
    }
    return cart;
                ...
                <div key={`${item._id}-${item.selectedColor || "default"}-${item.selectedSize || "default"}`} className="flex justify-between gap-4">
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-[10px] font-bold uppercase tracking-widest text-stone-400">
                      Qty: {item.qty}{item.selectedColor ? ` • ${item.selectedColor}` : ""}{(item.selectedSize || item.size) ? ` • Size: ${item.selectedSize || item.size}` : ""}
                    </p>
                  </div>
