                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <p className="mt-1 text-xs font-bold uppercase tracking-widest text-stone-400">
                        {[item.fabric, item.selectedColor || item.color].filter(Boolean).join(" • ")}
                      </p>
                      {item.selectedSize && (
                        <p className="mt-1.5 text-xs font-bold text-stone-600">
                          Size: <span className="rounded-md bg-stone-100 px-2 py-0.5 font-black text-stone-900">{item.selectedSize}</span>
                        </p>
                      )}
                    </div>
                    <button
