...
export const isSizeApplicable = (product) => {
  if (!product) return false;
  if (typeof product.sizeApplicable === "boolean") {
    return product.sizeApplicable;
  }
  if (typeof product.size_applicable === "boolean") {
    return product.size_applicable;
  }
