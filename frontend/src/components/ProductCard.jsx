...
import { formatCurrency, getMarketPrice, getOfferPrice, getProductColors, getProductImage, hasOfferPrice, isSizeApplicable } from "../utils/catalog";
...
export default function ProductCard({ product, dark = false, onCardClick }) {
  ...
  const sizeReq = isSizeApplicable(product);
      ...
      <div className="flex flex-col p-6">
        ...
        <div className="mt-auto">
          ...
          <div className="mt-6">
            ...
            >
              {product.stock === 0 ? "Sold Out" : sizeReq ? "Select Size" : "Add to Bag"}
            </button>
          </div>
        </div>
      </div>
